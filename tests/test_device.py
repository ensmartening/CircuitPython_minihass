...
def test_Device_add_entity(entities, mqtt_client):
    ...
    expected_payload = '{"avty": [{"t": "homeassistant/bar1337d00d/availability"}, {"t": "homeassistant/device/mqtt_device1337d00d/availability"}], "en": true, "unique_id": "bar1337d00d", "e": "utf-8", "stat_t": "homeassistant/bar1337d00d/state", "name": "bar", "force_update": false, "pl_off": false, "pl_on": true, "expire_after": 0, "dev": {"ids": ["mqtt_device1337d00d"], "cns": []}}'
...
def test_Device_announce(entities, mqtt_client):
    ...
    expected_msg = '{"avty": [{"t": "homeassistant/baz1337d00d/availability"}, {"t": "homeassistant/device/mqtt_device1337d00d/availability"}], "en": true, "unique_id": "baz1337d00d", "e": "utf-8", "name": "baz", "dev": {"ids": ["mqtt_device1337d00d"], "cns": [], "mf": "Genericor", "hw": "0.1"}, "stat_t": "homeassistant/device/mqtt_device1337d00d/state", "val_tpl": "{{ value_json.baz1337d00d }}", "force_update": false, "pl_off": false, "pl_on": true}'
    o.announce()
...
def test_Device_availability(device):
    ...
    expected_topic = "homeassistant/device/mqtt_device1337d00d/availability"
    expected_msg = "online"
...
def test_Device_mqtt_on_connect_cb(entities, mqtt_client):
    ...
    announce_msg = '{"avty": [{"t": "homeassistant/baz1337d00d/availability"}, {"t": "homeassistant/device/mqtt_device1337d00d/availability"}], "en": true, "unique_id": "baz1337d00d", "e": "utf-8", "name": "baz", "dev": {"ids": ["mqtt_device1337d00d"], "cns": []}, "stat_t": "homeassistant/device/mqtt_device1337d00d/state", "val_tpl": "{{ value_json.baz1337d00d }}", "force_update": false, "pl_off": false, "pl_on": true}'
