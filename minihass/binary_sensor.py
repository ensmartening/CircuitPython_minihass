...
class BinarySensor(_Entity):
    ...
    :param unique_id_suffix: Entity `unique_id` is genrated by concatenating `name` or
        `object_id` onto the device's unique identifier. Set to use a different string
    ...
    :param enabled_by_default: Specifies whether the entity should be enabled when it
        is first added, defaults to `false`
